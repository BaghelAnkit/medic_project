                        ...
                        <div className="col-lg-4 col-md-7">
                            ...
                            <div className="block-2 app-promotion">
                                ...
                                <div className="download-btn d-flex my-3">
                                    <a href="index.html"><img src="images/apps/google-play-store.png" className="img-fluid" alt="" /></a>
                                    <a href="index.html" className=" ml-3"><img src="images/apps/apple-app-store.png" className="img-fluid" alt="" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
